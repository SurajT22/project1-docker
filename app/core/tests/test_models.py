...
class ModelTests(TestCase):
    ...
    def test_create_job_title(self):
        ...
        user = get_user_model().objects.create_user("test@example.com", "password@321")
        portal = models.Portal.objects.create(
            name="naukri.com", user=user, description="famous job portal in India"
        )
        ...
        self.assertEqual(str(job_title), job_title.title + f"( {job_title.portal} )")
